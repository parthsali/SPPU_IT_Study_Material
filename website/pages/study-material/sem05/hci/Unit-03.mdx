...
2. [Categorization of Users](#categorization-of-users)
3. [Goal and Task Hierarchy Model](#goal-and-task-hierarchy-model)
4. [Linguistic Model](#linguistic-model)
5. [Physical and Device Models](#physical-and-device-models)
6. [GOMS Model](#goms-model)
7. [Norman's 7-Stage Model](#normans-7-stage-model)
8. [Cognitive Architectures](#cognitive-architectures)
9. [Hierarchical Task Analysis (HTA)](#hierarchical-task-analysis-hta)
10. [Uses of Task Analysis](#uses-of-task-analysis)
11. [Diagrammatic Dialog Design Notations](#diagrammatic-dialog-design-notations)
