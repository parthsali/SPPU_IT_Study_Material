...
1. [What is HCI?](#what-is-hci)
   - Definition of HCI
   - Goals of HCI
   - Importance of HCI in Technology
2. [Disciplines Involved in HCI](#disciplines-involved-in-hci)
   - Computer Science
   - Cognitive Psychology
   - Design and Ergonomics
   - Sociology and Anthropology
3. [Why HCI Study is Important](#why-hci-study-is-important)
   - Enhancing User Experience
   - Usability in Design
   - Human-Centered Technology
4. [The Psychology of Everyday Things](#the-psychology-of-everyday-things)
   - Concept by Donald A. Norman
   - Design Principles from Psychology
5. [Principles of HCI](#principles-of-hci)
   - Affordance
   - Feedback
   - Consistency
   - Discoverability
6. [User-Centered Design](#user-centered-design)
   - Process of User-Centered Design
   - Importance in HCI
   - Examples and Best Practices
7. [Measurable Human Factors](#measurable-human-factors)
   - Efficiency
   - Effectiveness
   - Satisfaction
