...
2. [Univariate Regression](#univariate-regression)
   - Least-Square Method
...
3. [Multivariate Regression](#multivariate-regression)
   - Model Representation
4. [Introduction to Polynomial Regression](#introduction-to-polynomial-regression)
   - Generalization
