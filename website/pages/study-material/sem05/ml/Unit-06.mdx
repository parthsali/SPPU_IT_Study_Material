...
1. [Perceptron Learning](#perceptron-learning)
   - Biological Neuron
   ...
   - Activation Functions
     - Tanh
     - ReLU
2. [Multi-layer Perceptron Model](#multi-layer-perceptron-model)
   - Introduction
   - Learning Parameters: Weight and Bias
   - Loss Function: Mean Square Error
3. [Introduction to Deep Learning](#introduction-to-deep-learning)
