...
2. [The Evolution of Operating Systems](#the-evolution-of-operating-systems)
   - Batch Processing Systems
   - Time-Sharing Systems
   - Real-Time and Distributed Systems
3. [Developments Leading to Modern Operating Systems](#developments-leading-to-modern-operating-systems)
...
5. [Introduction to Linux OS](#introduction-to-linux-os)
   - Features of Linux
   - Linux Kernel and Distributions
6. [BASH Shell Scripting](#bash-shell-scripting)
