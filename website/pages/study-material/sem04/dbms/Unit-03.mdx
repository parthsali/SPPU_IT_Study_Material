...
1. [Introduction to SQL](#introduction-to-sql)
   ...
   - SQL Operators
2. [Tables and Views](#tables-and-views)
   - Creating, Modifying, Deleting Tables
   - Creating, Dropping, Updating Views
   - Indexes and Nulls
3. [SQL DML Queries](#sql-dml-queries)
   ...
   - Aggregate Functions
   - Nested Queries
   - Database Modification (Insert, Update, Delete Queries)
4. [Stored Procedures and Triggers](#stored-procedures-and-triggers)
5. [Programmatic SQL](#programmatic-sql)
   - Embedded SQL
   - Dynamic SQL
