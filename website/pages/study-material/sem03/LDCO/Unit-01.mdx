...
1. [Digital Logic Families](#digital-logic-families)
   - Digital IC Characteristics
   - TTL (Transistor-Transistor Logic)
   - CMOS (Complementary Metal-Oxide Semiconductor)
   - Comparison of TTL & CMOS
2. [Signed Binary Number Representation and Arithmetic](#signed-binary-number-representation-and-arithmetic)
   - Sign Magnitude
   - 1’s Complement
   - 2’s Complement
   - Unsigned Binary Arithmetic (Addition, Subtraction, Multiplication, Division)
   - Subtraction using 2’s Complement
   - IEEE Standard 754 Floating Point Representation
3. [Codes](#codes)
   - Binary, BCD, Octal, Hexadecimal
   - Excess-3 Code, Gray Code
4. [Logic Minimization](#logic-minimization)
   - Logic Functions: Statement, Truth Table, SOP, POS
