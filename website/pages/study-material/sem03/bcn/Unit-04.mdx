...
1. [Network Layer Services](#network-layer-services)
2. [IPv4 Addresses](#ipv4-addresses)
   ...
   - Subnetting
   - Supernetting
3. [Delivery and Forwarding of IP Packets](#delivery-and-forwarding-of-ip-packets)
4. [Structure of a Router](#structure-of-a-router)
5. [IPv4 Datagrams](#ipv4-datagrams)
   - Fragmentation
   - Options
   - Checksum
6. [IPv6 Addressing](#ipv6-addressing)
   ...
   - Address Space
   - Packet Format
7. [Transition from IPv4 to IPv6](#transition-from-ipv4-to-ipv6)
